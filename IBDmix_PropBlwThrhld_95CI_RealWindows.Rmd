...
RD.prop_blw_thrhld <- Prop_blw_thrhld.fn(callset = 'EUR_EAS_AFR', sample_size = 1511, min_window = 1, quer_prop = 0.75)
...
Bootstrapped.prop_blw_thrhld <- CI.95.fn(reps = 100, callset = 'EUR_EAS_AFR', sample_size = 1511, min_window = 1, quer_prop = 0.75)
...
ggplot() + theme_classic() + 
  ...
  geom_line(data=EUR_EAS_YRI.SimData.prop_blw_thrhld, aes(x=ws, y=prop_blw_thrhld), linetype="solid", color="black") +
  geom_line(data=EUR_EAS_AFR.SimData.prop_blw_thrhld, aes(x=ws, y=prop_blw_thrhld), linetype="solid", color="orange4") +
  # geom_line(data=SimData.prop_blw_thrhld, aes(x=ws, y=prop_blw_thrhld), linetype="solid", color="blue") +
  # geom_line(data=Sstar.prop_blw_thrhld, aes(x=winsize, y=prop_blw_thrhld), linetype="dashed", color="green4") +
  # geom_ribbon(data=Sstar.prop_blw_thrhld.CI,aes(x=Winsize, ymin=lwr, ymax=upr), fill="green4", alpha=0.75) + 
