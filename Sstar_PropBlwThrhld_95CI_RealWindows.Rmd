...
Sstar.Bootstrapped.prop_blw_thrhld <- CI.95.fn(reps = 1000, callset = 'EUR_EAS', sample_size =(1523*2), min_window = 5, quer_prop = 0.9)
...
Sstar.CI <- replace_na(CI,list(lower=0, upper=0))
